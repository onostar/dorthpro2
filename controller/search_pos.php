<?php
    ...
    $details = $get_revenue->fetch_details_2dateCon('payments', 'payment_mode', 'date(post_date)', $from, $to, 'Pos');
    $n = 1;  
?>
...
<?php
    ...
    $amounts = $get_total->fetch_sum_2dateCond('payments', 'amount_paid', 'payment_mode', 'date(post_date)', $from, $to, 'Pos');
