<?php
    ...
    $details = $get_checkIns->fetch_details_2dateCon('stock_adjustments', 'store', 'date(adjust_date)', $from, $to, $store);
    $n = 1;  
?>
<h2>Stock adjustments Report between '<?php echo date("jS M, Y", strtotime($from)) . "' and '" . date("jS M, Y", strtotime($to))?>'</h2>
    <hr>
    <div class="search">
...
?>
    ...
    <td style="text-align:center; color:red;"><?php echo $n?></td>
                ...
                <td><?php echo date("m-d-Y", strtotime($detail->adjust_date));?></td>
