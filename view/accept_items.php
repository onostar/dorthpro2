...
<div class="displays allResults new_data" id="revenue_report">
    <h2>List of items transferred to store</h2>
    <hr>
    <div class="search">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_2cond('transfers', 'to_store', 'transfer_status', $store, 1);
            ...
            <tr>
                ...
                <td>
                    <?php
                        ...
                        $strs = $get_store->fetch_details_group('stores', 'store', 'store_id', $detail->from_store);
                        echo $strs->store;
                    ?>
                </td>
                ...
                <td>
                    ...
                    <a style="background:red; padding:5px 8px; border-radius:5px; color:#fff" href="javascript:void(0)" title="Reject item" onclick="rejectItem('<?php echo $detail->transfer_id?>')"> <i class="fas fa-cancel"></i></a>
                </td>
