...
<div id="stockAdjustReport" class="displays management" >
    <div class="select_date">
        ...
        <section>    
            ...
            <button type="submit" name="search_date" id="search_date" onclick="searchRemoval()">Search <i class="fas fa-search"></i></button>
    </section>
    </div>
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_curdate('remove_items', 'date(removed_date)');
