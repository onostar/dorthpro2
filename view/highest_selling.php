...
<div class="displays allResults new_data" id="revenue_report" style="width:60%!important; margin:0 50px!important">
    ...
    <div class="search">
        ...
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('data_table', 'Highest Selling item')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_curdateGroMany('sales', 'item', 'quantity', 'total_amount', 'date(post_date)', 'sales_status', 2, 'item', 'SUM(total_amount)');
